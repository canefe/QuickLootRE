...
def parse_arguments():
	...
	parser.add_argument("--plugin-files", type=str, help="the plugins files to archive", nargs="+", required=True)
	...
	parser.add_argument("--swf-files", type=str, help="the swf files to archive", nargs="+", required=True)
